 ...
 */
function getIconContractByteCode(jarPath) {
  try {
 ...
 */
function isDeployed(deploymentsPath) {
  try {
 ...
 */
function saveDeployments(deployments, deploymentsPath) {
  try {
 ...
 */
function getDeployments(deploymentsPath) {
  try {
 ...
 */
function getDappContract(solPath) {
 ...
 */
function getXcallContract(xcallAbiPath) {
